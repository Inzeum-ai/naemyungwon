...
const screens = [
  { id: 'sleep', title: '수면', src: '/images/app/sleep.png', heading: '잠들기 전, 하루를 내려놓아요.', body: '잠들기 전에 듣는 명상을 한곳에 모았어요. 오늘의 몸과 마음에 맞는 수련을 골라보세요.', alt: '수면 화면 — 잠들기 전 명상 목록' },
  { id: 'library', title: '명상', src: '/images/app/library.png', heading: '짧게 시작하고, 꾸준히 이어가요.', body: '호흡 명상부터 감사 명상까지. 일상에서 반복할 수 있는 내면소통명상을 찾아보세요.', alt: '명상 화면 — 호흡 명상과 명상 라이브러리' },
  { id: 'inner-ai', title: '내면AI', src: '/images/app/inner-ai.png', heading: '지금 필요한 수련을 찾아요.', body: '명상과 기록에 대해 대화하고, 지금의 몸과 마음에 맞는 명상을 안내받아요.', alt: '내면AI 화면 — 대화와 명상 안내' },
  { id: 'record', title: '기록', src: '/images/app/record.png', heading: '하루의 마음을 남겨요.', body: '감정과 몸감각, 감사한 일을 기록해요. 지나온 날의 기록을 다시 살펴볼 수 있어요.', alt: '기록 화면 — 기록을 모아 보는 달력' },
]
