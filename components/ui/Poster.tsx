...
// A printed poster shown as the document it is: 2:3, a soft hairline and the 12 px radius the
// 2026 retreat poster already carries, never a photograph's square bleed. Opens the full sheet in
// a new tab, since the type on it is meant to be read.
