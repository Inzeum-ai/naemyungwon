...
- Public 5th foundation cohort notice `https://inzeum.web.app/public/foundation-course-5/index.html`, checked 2026-09-08: September 16 at 20:00 start; September 10 application deadline; 12 weeks/about 30 hours; ₩400,000 new / ₩100,000 repeat; education signup then application review. Direct form URL extracted from the notice. No form submitted. On September 10 the site changed the cohort state to 지원 마감 and removed links to the notice and application form. Keep closed cohorts factual rather than presenting an active application CTA.
