...
export default function BookShelf() {
  return <ul className="author-books">{JOOHAN_BOOKS.map(book => <li key={book.slug}><Reveal>
    <a className="author-book" href={book.href} target="_blank" rel="noopener noreferrer" aria-label={`${book.title} — 교보문고에서 보기 (새 창)`}>
      ...
      <p className="author-book-store">교보문고에서 보기</p>
