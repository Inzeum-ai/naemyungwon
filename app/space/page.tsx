...
export const metadata = pageMetadata({ title:'인지엄 홀', description:'청담에 준비하는 명상과 수련의 공간, 인지엄 홀. 촉각으로 들어와, 빛에 머물고, 차 한 잔의 고요함으로 이어지는 공간의 구상.', path:'/space' })
export default function SpacePage() {
 return <PageShell>
  <section className="space-opening studio-shell"><p className="eyebrow">INZEUM HALL · 청담 · 준비 중</p><h1>고요함에,<br />자리를 내어줍니다.</h1><p>명상을 배우고, 함께 수련하고, 오래 머무를 공간.<br />인지엄 홀을 준비하고 있습니다.</p></section>
  <div className="studio-shell"><ScrollImage src="/images/space/hall-proposal.webp" alt="인지엄 홀 설계 제안, 곡선으로 이어지는 명상 자리와 천장의 빛" width={1920} height={1080} priority caption="설계 제안 이미지 · 실제 완공 모습과 다를 수 있습니다." /></div>
  ...
  <Section title="공간의 다음 소식을 전하겠습니다." width="content"><p className="text-body-lg text-sub">현재 준비 중인 공간입니다. 개관일, 이용 방법과 프로그램은 확정 후 안내합니다.</p><TextLink href="/news" className="mt-6">인지엄 소식</TextLink></Section>
 </PageShell>
}
