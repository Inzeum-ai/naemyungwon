  ...
  return <section id="ai-native" className="ai-story studio-shell">
    ...
    <div className="ai-story-content">
      ...
      <ol className="ai-steps">
        ...
        <li><span>02</span><div><h3>근거를 찾아 안내하고</h3><p>AI 에이전트가 책과 강의를 직접 찾아 읽고, 수련을 제안합니다.</p></div></li>
      ...
      {full && <div className="ai-operating"><h3>AI와 함께 만드는 팀</h3><p>인지움은 AI를 제품과 일하는 방식의 중심에 둡니다. 소수의 팀이 AI 에이전트와 함께 연구 자료를 정리하고, 판단에 필요한 정보를 모으고, 콘텐츠와 소프트웨어를 만듭니다. 행사 안내, 신청 도구, 일정과 문서 정리도 자동화합니다.</p><p>사람은 방향을 정하고 결과를 검토합니다. 더 많은 시간을 교육과 수련의 경험에 쓸 수 있도록.</p></div>}
    </div>
  </section>
}
